...
@section('content')
    <div class="p-4">
        <div class="bg-white rounded-xl p-6 w-full max-w-8xl relative shadow-[0_-4px_10px_rgba(0,0,0,0.08),0_6px_15px_rgba(0,0,0,0.1)]">
            ...
            <a href="{{ url()->previous() }}" class="absolute top-7 left-6 flex items-center gap-1 text-gray-500 hover:text-red-800 transition-colors">
            ...
            <h1 class="text-center text-red-800 text-2xl font-bold mb-8">TAMBAH DESSERT</h1>
            ...
            <form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- Nama Menu --}}
                <div class="mb-4">
                    <label class="block font-semibold">Nama Dessert</label>

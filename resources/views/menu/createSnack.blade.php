    ...
    <div class="p-4">
        <div class="bg-white rounded-xl p-6 w-full max-w-8xl relative shadow-[0_-4px_10px_rgba(0,0,0,0.08),0_6px_15px_rgba(0,0,0,0.1)]">
            ...
            <form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Nama Snack</label>
                    ...
                    @error('nama_menu')
                        <p class="text-red-600 text-xs font-bold mt-1 italic underline">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-400 text-[10px] mt-1 italic font-medium">* Format: JPG, PNG, JPEG, WEBP (Maks. 2MB)</p>
                    @error('gambar')
                        <p class="text-red-600 text-xs font-bold mt-1 italic underline">{{ $message }}</p>
                    @enderror
                </div>
